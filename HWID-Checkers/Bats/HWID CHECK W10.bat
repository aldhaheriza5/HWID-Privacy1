...
powershell -Command "Get-WmiObject Win32_DiskDrive | ForEach-Object { '{0}  {1}  {2}' -f $_.DeviceID, $_.Model, $_.SerialNumber }"
powershell -Command "wmic logicaldisk get deviceid,volumeserialnumber | ForEach-Object { $_.Trim() } | Where-Object { $_ } | Select-Object -Skip 1 | ForEach-Object { $parts = $_ -split '\\s+'; '{0} {1}' -f $parts[0], $parts[1] }"

echo %PURPLE%======================================================================================================================
echo %BRIGHTCYAN%                                                       CPU
echo %PURPLE%======================================================================================================================%BRIGHTRED%
powershell -Command "wmic cpu get processorid,serialnumber | ForEach-Object { $_.Trim() } | Where-Object { $_ }"

echo %PURPLE%======================================================================================================================
echo %BRIGHTCYAN%                                                  SYSTEM INFORMATION
echo %PURPLE%======================================================================================================================%LIGHTBLUE%
powershell -Command "$uuid = (Get-WmiObject -Class Win32_ComputerSystemProduct).UUID; Write-Output ('UUID: ' + $uuid)"
...
powershell -Command "Write-Output ('Serial Number (Product ID): ' + (Get-WmiObject -Class Win32_OperatingSystem).SerialNumber)"

echo %PURPLE%======================================================================================================================
echo %BRIGHTCYAN%                                                    MOTHERBOARD
echo %PURPLE%======================================================================================================================%BRIGHTRED%
powershell -Command "wmic baseboard get manufacturer,product,serialnumber,version | ForEach-Object { $_.Trim() } | Where-Object { $_ }"

echo %PURPLE%======================================================================================================================
echo %BRIGHTCYAN%                                                     (SM)BIOS
echo %PURPLE%======================================================================================================================%LIGHTBLUE%
powershell -Command "wmic bios get manufacturer,serialnumber,version | ForEach-Object { $_.Trim() } | Where-Object { $_ }"
echo.
powershell -Command "wmic path win32_computersystemproduct get identifyingnumber,uuid,vendor,version | ForEach-Object { $_.Trim() } | Where-Object { $_ }"

echo %PURPLE%======================================================================================================================
echo %BRIGHTCYAN%                                                    RAM MODULES
echo %PURPLE%======================================================================================================================%BRIGHTRED%
powershell -Command "wmic memorychip get devicelocator,serialnumber | ForEach-Object { $_.Trim() } | Where-Object { $_ }"
...
if %errorlevel% equ 0 (
    ...
    powershell -Command "wmic path win32_videocontroller get name,pnpdeviceid | ForEach-Object { $_.Trim() } | Where-Object { $_ }"
)
...
echo %PURPLE%======================================================================================================================%LIGHTBLUE%
powershell -Command "wmic nic where 'MACAddress is not null' get macaddress,name,deviceid | ForEach-Object { $_.Trim() } | Where-Object { $_ }"
